...
<div class="container">
    <div class="card">
        <div class="card-header">
          <h6 class="card-title text-primary font-weight-bold"> Create new  Franchise </h6>
        </div>
        <div class="card-body">
            @if ($errors->any())
                    ...
                    <form action="{{route('admin.franchises.store')}}" method="POST">
                     ...
                     <div class="row">
                        ...
                        <div class="from-group my-1 col-md-6">
                           ...
                           <input type="text" name="citizenship_no" required class="form-control" value="{{old('citizenship_no')}}">
                        </div>
                        <div class="from-group my-1 col-md-6">
                        ...
                        <div class="from-group my-1 col-md-6">
                           ...
                           <input type="text" name="dob" required class="form-control datepicker" value="">
                        </div>

                        <div class="from-group my-1 col-md-6">
                            <label>Citizenship issue District</label>
                           <input type="text" name="citizen_issue_place" required class="form-control" value="{{old('citizen_issue_place')}}">
                        </div>

                        <div class="from-group my-1 col-md-6">
                            <label>Citizenship issue date</label>
                           <input type="text" name="citizen_issue_date" required class="form-control datepicker" value="">
                        </div>
